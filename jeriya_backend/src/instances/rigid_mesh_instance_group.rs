...
impl RigidMeshInstanceGroup {
    ...
    pub fn new(gpu_index_allocator: &Arc<impl ProvideAllocateGpuIndex<RigidMeshInstance>>, debug_info: DebugInfo) -> Self {
        Self {
    ...
    pub fn insert_with(
        ...
        self.rigid_mesh_group
            ...
            .insert_with(|handle| {
                ...
                let result = rigid_mesh_instance_builder.build(*handle, gpu_index_allocation);
                if result.is_err() {
