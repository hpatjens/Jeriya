...
use jeriya_backend::{
    immediate::{self, ImmediateRenderingFrame, LineList, LineStrip, TriangleList, TriangleStrip},
...
pub struct ImmediateRenderingFrameTask {
    ...
    pub immediate_command_buffer_handlers: Vec<AshImmediateCommandBufferHandler>,
}
